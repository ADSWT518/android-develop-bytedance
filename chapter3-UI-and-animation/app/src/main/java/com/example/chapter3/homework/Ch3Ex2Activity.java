...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator2_1_1 = ObjectAnimator.ofFloat(target,
                "scaleX",
                1f,
                2f);
        animator2_1_1.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animator2_1_1.setRepeatCount(ObjectAnimator.INFINITE);
        animator2_1_1.setRepeatMode(ObjectAnimator.REVERSE);
        ObjectAnimator animator2_1_2 = ObjectAnimator.ofFloat(target,
                "scaleY",
                1f,
                2f);
        animator2_1_2.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animator2_1_2.setRepeatCount(ObjectAnimator.INFINITE);
        animator2_1_2.setRepeatMode(ObjectAnimator.REVERSE);
        ...
        animatorSet.playTogether(animator1, animator2_1_1, animator2_1_2, animator2_2);
        animatorSet.start();
    }
}
